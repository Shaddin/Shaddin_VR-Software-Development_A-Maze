...
public class Door : MonoBehaviour {
   ...
   public AudioSource audioSource;
    ...
    void Start () {
        ...
        leftDoorEndRotation = Quaternion.Euler(0f, 0f, -90f);
        rightDoorStartRotation = rightDoor.transform.rotation;
        rightDoorEndRotation = Quaternion.Euler(0f, 0f, 90f);
    }
    ...
    public void OnDoorClicked()
    {
        ...
        if (locked == false)
        {
            audioSource.clip = Door_Opening; audioSource.Play();
            opening = true; audioSource.clip = Door_Locked; audioSource.Play();
        }
